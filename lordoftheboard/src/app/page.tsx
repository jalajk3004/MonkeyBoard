            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mr-10">
              ...
              >
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  , a dynamic space where creativity and collaboration meet in
                  real-time! Our interactive whiteboard allows users to draw,
                  sketch, and brainstorm together seamlessly, no matter where
                  they are. Whether you&apos;re working on a project, planning
                  ideas, or simply having fun, our platform offers smooth,
                  instant collaboration with multiple participants. Join in and
                  bring your ideas to life, together, in a shared virtual
                  canvas.
                </p>
                <motion.button
